...
| 3 | **Nombre:** Song Ju Loo <br> **Edad:** 22 <br> **Distrito:** El Agustino <br> **Ocupación:** Dueño de una tienda de productos al por mayor <br> **Link:** — | El entrevistado, dueño de una tienda de productos al por mayor, refleja una fuerte preocupación por la seguridad de su negocio, ya que cualquier pérdida de mercadería impacta directamente en sus ingresos. Señala que ha experimentado faltantes dentro del local, sin poder identificar con certeza si se trata de errores o robos, lo que evidencia una falta de control preciso en su operación.<br>Actualmente utiliza cámaras de vigilancia y se apoya en la confianza del personal, pero reconoce que este sistema es limitado, ya que no puede supervisar constantemente lo que ocurre en el almacén.<br>Valora altamente la posibilidad de monitorear en tiempo real y recibir alertas inmediatas en su celular ante situaciones inusuales, como aperturas fuera de horario o movimientos sospechosos. Además, considera importante poder revisar registros o historiales para entender incidentes pasados.<br>Busca una solución simple, accesible desde el celular y fácil de usar, priorizando rapidez y funcionalidad sobre complejidad. Su principal interés es prevenir robos, evitar pérdidas y tener mayor control sin necesidad de estar físicamente presente, mostrando disposición a adoptar herramientas como Locksight siempre que sean económicas y prácticas. | <p align="center"><img src="./assets/screenshot-interview-song-ju-loo.png" width="300"></p> |
