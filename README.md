...
<div align="center">
  <img src="./assets/mermaid-diagram-valueobjects-boundedcontext.png" alt="Class Diagram Value Objects- Bounded Context - LockSight" width="1000">
</div>
...
| **Sprint Goal & User Stories** | |
| Sprint 4 Goal | Nuestro objetivo es entregar una versión final de Locksight que permita a las empresas supervisar sus almacenes de forma centralizada, reducir el riesgo de pérdidas por incidentes de seguridad y mejorar la capacidad de respuesta mediante alertas, historial de eventos, reportes y gestión de usuarios. Esto se validará cuando un administrador pueda registrar su empresa, gestionar almacenes y dispositivos IoT, atender alertas, consultar eventos, generar reportes y operar la solución desde una Web Application pública conectada a servicios desplegados en la nube. |
